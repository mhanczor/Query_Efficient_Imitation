...
filepaths = {'DAgger':DAgger_fp, 'Concrete':Concrete_fp, 'Rand Basic 1e5':rand_basic_1e5, 'Conc DW 0.5':dw_05, 'Conc DW 1.0':dw_10, 'Conc DW 5e-4':dw_5e4}
s_val = 13
# interpolate = ['DAgger']
...
plot.plotData(data, plot_labels, expert=expert_valid, data_axis=3, xlims=(0, 2000), ylims=None, smoothing=None)
plot_labels = ['Expert_Samples', 'Success Rate', 'FetchReach-v1']
plot.plotData(data, plot_labels, expert=expert_success, data_axis=4, xlims=(0, 2000), ylims=None, smoothing=None)
...
plot.plotData(data, plot_labels, data_axis=6, xlims=(0, 2000), ylims=None, smoothing=None)
